...
ARG NOTION_RESUME_DATABASE_ID
ARG NOTION_RESUME_DOWNLOAD_PAGE_ID
ARG QQ_SMTP_EMAIL
...
RUN echo "NOTION_RESUME_DATABASE_ID=${NOTION_RESUME_DATABASE_ID}" >> .env.production
RUN echo "NOTION_RESUME_DOWNLOAD_PAGE_ID=${NOTION_RESUME_DOWNLOAD_PAGE_ID}" >> .env.production
