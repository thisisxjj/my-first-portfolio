...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      subject: `${reqBody.fullName} - ${reqBody.companyName}`,
    })
